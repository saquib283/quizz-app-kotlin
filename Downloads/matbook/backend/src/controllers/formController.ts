...
export const getFormSchema = catchAsync(async (req: Request, res: Response) => {
    res.status(200).json(formSchema);
});

export const submitForm = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const data = req.body;
    const id = uuidv4();
...
export const deleteSubmission = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
export const updateSubmission = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
    const data = req.body;
